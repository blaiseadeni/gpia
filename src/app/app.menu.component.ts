...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {
                label: 'ELEMENTS DE BASE', icon: 'pi pi-fw pi-star-fill',
                items: [
                    {label: 'Communes', icon: 'pi pi-fw pi-id-card', routerLink: ['/base/communes']},
                    {label: 'Quartiers', icon: 'pi pi-fw pi-id-card', routerLink: ['/base/quartiers']},
                    {label: 'Rues', icon: 'pi pi-fw pi-id-card', routerLink: ['/base/rues']},
                    {label: 'Compteurs', icon: 'pi pi-fw pi-check-square', routerLink: ['/base/compteurs']},
                    {label: 'Agences', icon: 'pi pi-fw pi-check-square', routerLink: ['/base/agences']},
                    {label: 'Type client', icon: 'pi pi-fw pi-check-square', routerLink: ['/base/type']},
                ]
            },
            {
                label: 'OPERATIONS', icon: 'pi pi-fw pi-star-fill',
                items: [
                    {label: 'Abonnés', icon: 'pi pi-bookmark', routerLink: ['/base/abonnes']},
                    { label: 'Prélèvement', icon: 'pi pi-exclamation-circle', routerLink: ['/base/indexages'] },

                ]
            },
            {
                label: 'RAPPORTS', icon: 'pi pi-fw pi-star-fill',
                items: [
                    {label: 'Factures', icon: 'pi pi-exclamation-circle', routerLink: ['/base/facturation']},

                ]
            },
            {
                label: 'EDITIONS', icon: 'pi pi-fw pi-star-print',
                items: [
                    {label: 'Listing', icon: 'pi pi-exclamation-circle', routerLink: ['/base/listing']},
                    {label: 'Facture', icon: 'pi pi-fw pi-mobile', routerLink: ['/base/facture'], class: 'rotated-icon'},
                ]
            },
            {
